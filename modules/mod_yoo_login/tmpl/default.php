	...
	<span class="yoo-login">
		...
		<span class="login">
			...
			<span class="username">
				...
				<br />
				<input id="modlgn_username<?php echo $yoologin_id; ?>" type="text" name="username" size="18" />
				<?php } ?>
			...
			<span class="password">
				...
				<br />
				<input id="modlgn_passwd<?php echo $yoologin_id; ?>" type="password" name="passwd" size="10" />
				<?php } ?>
			...
			<?php } else { ?>
			<span class="remember">
				<input id="modlgn_remember<?php echo $yoologin_id; ?>" type="checkbox" name="remember" value="yes" />
