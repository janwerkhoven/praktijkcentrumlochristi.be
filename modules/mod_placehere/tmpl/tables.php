...
<tr>
	...
	<?php if (($user->authorize('com_content', 'edit', 'content', 'all') || $user->authorize('com_content', 'edit', 'content', 'own'))) : ?>
		<td align="right" width="100%" class="buttonheading">
			<?php echo JHTML::_('icon.edit', $article, $params, $access); ?>
		</td>
	<?php endif; ?>	
...
<tr>
	<td valign="top" colspan="2">
		<a href="http://<?php echo $article->urls ; ?>">
