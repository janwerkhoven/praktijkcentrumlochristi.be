...
<p class="<?php echo $params->get('p_class'); ?>"><?php echo $params->get('tekst_links'); ?> <a href="<?php echo $params->get('url_medisites'); ?>" target="_new">Medisites</a> - <a href="<?php echo $params->get('url_sitemap'); ?>">Sitemap</a> - <a href="#" onclick="return hs.htmlExpand(this, { contentId: 'highslide-html-logoutform', wrapperClassName: 'mod_cd_login', outlineType: '<?php echo $outlineType; ?>', align: '<?php echo $align; ?>', anchor: '<?php echo $anchor; ?>', dimmingOpacity: <?php echo $dimmingOpacity; ?>, slideshowGroup: 'mod_cd_login_logoutform' } )" title="<?php echo JText::_('CDLOGIN_BUTTON_LOGOUT'); ?>">Logout</a></p>
</div>
...
<input type="submit" name="Submit" class="art-button cd_login-logoutbutton" value="<?php echo JText::_('CDLOGIN_BUTTON_LOGOUT'); ?>" title="<?php echo JText::_('CDLOGIN_BUTTON_LOGOUT'); ?>" />
</fieldset>
...
<!--
<div class="cd_moduletitle_logo">
<p class="<?php echo $params->get('p_class'); ?>"><?php echo $params->get('tekst_links'); ?> <a href="<?php echo $params->get('url_medisites'); ?>" target="_new">Medisites</a> - <a href="<?php echo $params->get('url_sitemap'); ?>">Sitemap</a> - <a href="#"
	...
	title="<?php echo
	JText::_('CD_LOGIN_MODULE_TITLE'); ?>">Login
</a></p></div>
-->
...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="cd_login_form_login" id="cd_login_form_login">
<fieldset class="input">
<div>
<p id="form-login-username">
<label for="modlgn_username"><?php echo JText::_('CDLOGIN_USERNAME') ?></label><br />
<input id="modlgn_username" type="text" name="username" class="inputbox" title="<?php echo JText::_('CDLOGIN_USERNAME') ?>"	alt="username" size="18" /></p>
<p id="form-login-password"><label for="modlgn_passwd"><?php echo JText::_('CDLOGIN_PASSWORD') ?></label><br />
<input id="modlgn_passwd" type="password" name="passwd" class="inputbox" size="18" title="<?php echo JText::_('CDLOGIN_PASSWORD') ?>" alt="password" /></p>
<p id="form-login-remember">
<input<?php if (!JPluginHelper::isEnabled('system', 'remember')): ?> disabled="disabled" <?php endif; ?> id="modlgn_remember" type="checkbox" name="remember" class="inputbox" value="yes" title="<?php echo JText::_('CDLOGIN_REMEMBER_ME') ?>" alt="<?php echo JText::_('CDLOGIN_REMEMBER_ME') ?>" />
<label
