/**
* @file
* @brief    sigplus Image Gallery Plus jQuery on-demand inclusion
...
function __jQuery_version_compare__() {
	...
	return _compare(jQuery().jquery, '1.4.2');
}
...
if (typeof(__jQuery__) == 'undefined') {
	...
	if (typeof(jQuery) == 'undefined' || !__jQuery_version_compare__()) {
		google.load('jquery', '1.4.2');  // .js file will be loaded after this script terminates
	} else {
