...
class fadeWebGalleryTheme {
	...
	function &getInstance() {
		static $instance;
		if ($instance == null) $instance = new fadeWebGalleryTheme();
		return $instance;
	}
	...
	function addScriptDeclaration() {
		...
		$dimming = $this->params->get('fade_dimming', 0.45);
		$fade_color = $this->params->get('fade_color', '#fff');
		
		$script = "
		<!--
		jQuery(function($) {
			$('.webgallery_fade a').fadeimage({ color: '$fade_color', dimming: $dimming });
		});
		//-->
		";
		return $script;
